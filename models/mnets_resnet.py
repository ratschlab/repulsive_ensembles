...
from mnets_classifier_interface import Classifier
from mnets_mnet_interface import MainNetInterface
from net_utils.batchnorm_layer import BatchNormLayer
from net_utils.torch_utils import init_params
...
hyper_shapes_distilled` and the current statistics will be returned by the
    ...
    def __init__(self, in_shape=(32, 32, 3), num_classes=10, use_bias=True,
                 ...
                 no_weights=True, init_weights=None, use_batch_norm=True,
                 bn_track_stats=True, distill_bn_stats=False,
                 context_mod_apply_pixel_wise=False,  out_act = None,**kwargs):
    ...
    def forward(self, x, weights=None, distilled_params=None, condition=None):
        ...
        if self.out_act is not None:
            return self.out_act(h), h #needed so that i can use second output for training first for predict
        else:
            return h
